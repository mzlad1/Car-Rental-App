...
public class ownerCars extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.ownerCar_recycler);
    ...
    private void fetchCars() {
        String url = "http://10.0.2.2:80/FinalProjectPHP/ownerCars.php?username=" + username;
    ...
    private void fetchRecycler() {
        ...
        ownerRecycler carRecyclerView = new ownerRecycler(status, price, model, name, image, id, usernames);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ownerCars.this, mainPageOwners.class);
